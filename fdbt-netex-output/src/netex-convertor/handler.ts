...
export const netexConvertorHandler = async (event: S3Event) => {
    try {
        ...
        const tndsItemData = await getItemFromDynamoDBTableWithPartitionKey(
            'giles-TNDS',
            'FileName',
            'ea_20-1A-A-y08-12019-12-20T12:29:46.8712Z',
        );
        ...
        const operatorShortnameArray = getAttributeValueFromDynamoDBItemAsStringArray(
            tndsItemData,
            'OperatorShortName',
        );
