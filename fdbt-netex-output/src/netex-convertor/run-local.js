...
var xml2json = __importStar(require("xml2json"));
...
*/
var streamOutputToCommandLine = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        fs_1.default.readFile('./test.xml', 'string', function (err, data) {
            var json = JSON.parse(parser.toJson(data, { reversible: true }));
            console.log(json);
            // var element = json["PublicationDelivery"]["Description"];
        });
        return [2 /*return*/];
    });
}); };
