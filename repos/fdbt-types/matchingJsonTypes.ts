...
export type FlatFareGeoZoneTicket = Omit<
  PeriodGeoZoneTicket,
  "products" | "type"
> & {
  type: "flatFare";
...
export interface BasePeriodTicket
  extends BaseTicket<"period" | "multiOperator"> {
  operatorName: string;
...
export interface PeriodHybridTicket
  extends PeriodGeoZoneTicket,
    PeriodMultipleServicesTicket {}
...
export interface SchemeOperatorMultiServiceTicket
  extends BaseSchemeOperatorTicket {
  type: "period";
  products: ProductDetails[];
  additionalOperators: {
    nocCode: string;
