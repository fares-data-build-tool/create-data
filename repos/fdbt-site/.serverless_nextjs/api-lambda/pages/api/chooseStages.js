module.exports = /******/ (function(modules) {
    ...
    /******/
    /******/
    /******/ /******/ return __webpack_require__((__webpack_require__.s = 'EnT+'));
    /******/
})(
    /************************************************************************/
    /******/ {
        ...
        /***/ '/nSZ': /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */ __webpack_require__.d(
                __webpack_exports__,
                'isInvalidFareStageNumber',
                function() {
                    return isInvalidFareStageNumber;
                },
            );
            ...
            const isInvalidFareStageNumber = req => {
                const { fareStageInput } = req.body; // eslint-disable-next-line no-restricted-globals
            ...
            /* harmony default export */ __webpack_exports__['default'] = (req, res) => {
                try {
                    ...
                    if (!req.body.fareStageInput) {
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_1__['redirectTo'])(res, '/chooseStages');
                        return;
                    }
                    ...
                    const cookieValue = JSON.stringify({
                        fareStages: numberOfFareStages,
                    });
                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_1__['setCookieOnResponseObject'])(
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_1__['getDomain'])(req),
                        _constants_index__WEBPACK_IMPORTED_MODULE_0__[/* FARE_STAGES_COOKIE */ 'd'],
                        cookieValue,
                        req,
                        res,
                    );
                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_1__['redirectTo'])(res, '/stageNames');
                } catch (error) {
                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_1__['redirectToError'])(res);
                }
            };
        ...
        /***/ 'EnT+': /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            ...
            function handleRewrites(parsedUrl) {
                for (const rewrite of private_dot_next_routes_manifest_json__WEBPACK_IMPORTED_MODULE_4__[
                    ...
                    if (params) {
                        ...
                        if (parsedUrl.pathname === '/api/chooseStages') {
                            break;
                        }
                    }
                }
            ...
            /* harmony default export */ __webpack_exports__['default'] = async (req, res) => {
                try {
                    ...
                    const resolver = __webpack_require__('/nSZ');
