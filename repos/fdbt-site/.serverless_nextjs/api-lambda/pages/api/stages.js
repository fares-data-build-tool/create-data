module.exports = /******/ (function(modules) {
    ...
    /******/
    /******/
    /******/ /******/ return __webpack_require__((__webpack_require__.s = 'JKWe'));
    /******/
})(
    /************************************************************************/
    /******/ {
        ...
        /***/ JKWe: /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            ...
            function handleRewrites(parsedUrl) {
                for (const rewrite of private_dot_next_routes_manifest_json__WEBPACK_IMPORTED_MODULE_4__[
                    ...
                    if (params) {
                        ...
                        if (parsedUrl.pathname === '/api/stages') {
                            break;
                        }
                    }
                }
            ...
            /* harmony default export */ __webpack_exports__['default'] = async (req, res) => {
                try {
                    ...
                    const resolver = __webpack_require__('wc0M');
        ...
        /***/ wc0M: /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            /* harmony import */ var _service_validator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__('MqiB');
            /* harmony import */ var _apiUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__('AivP');

            /* harmony default export */ __webpack_exports__['default'] = (req, res) => {
                try {
                    if (
                        !Object(_service_validator__WEBPACK_IMPORTED_MODULE_0__['isSessionValid'])(req, res) ||
                        !Object(_service_validator__WEBPACK_IMPORTED_MODULE_0__['isCookiesUUIDMatch'])(req, res)
                    ) {
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_1__['redirectToError'])(res);
                        return;
                    }

                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_1__['redirectTo'])(res, '/confirmation');
                } catch (error) {
                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_1__['redirectToError'])(res);
                }
            };
