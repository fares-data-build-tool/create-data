(function (global, factory) {
    ...
    class I18n {
        constructor(translations = {}, config = {}) {
            ...
            this.locale =
                (_config$locale = config.locale) != null ? _config$locale : document.documentElement.lang || 'en';
        }
        t(lookupKey, options) {
            if (!lookupKey) {
    ...
    class ErrorSummary extends ConfigurableComponent {
        ...
        getAssociatedLegendOrLabel($input) {
            ...
            return (_document$querySelect = document.querySelector(`label[for='${$input.getAttribute('id')}']`)) != null
    ...
    class Tabs extends Component {
        ...
        setup() {
            ...
            const $activeTab =
                (_this$getTab = this.getTab(window.location.hash)) != null ? _this$getTab : this.$tabs[0];
