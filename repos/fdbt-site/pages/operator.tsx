            ...
            <fieldset className="govuk-fieldset" aria-describedby="changed-name-hint">
              ...
              <div className="govuk-radios govuk-radios--inline">
                    <div className="govuk-radios__item">
                      <input className="govuk-radios__input" id="changed-name" name="operator" type="radio" value="MCT"/>
                      <label className="govuk-label govuk-radios__label" htmlFor="changed-name">
                    MCT
                  </label>
                    </div>
                    <div className="govuk-radios__item">
                      <input className="govuk-radios__input" id="changed-name-2" name="operator" type="radio" value="FirstBus"/>
