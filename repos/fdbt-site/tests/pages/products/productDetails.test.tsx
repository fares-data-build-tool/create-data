            ...
            expect(await getServerSideProps(ctx)).toStrictEqual({
                props: {
                    ...
                    productDetailsElements: [
                        ...
                        { id: 'period-duration', id: 'period-duration', name: 'Period duration', content: ['7 weeks'] },
                        { id: 'product-expiry', id: 'product-expiry', name: 'Product expiry', content: ['24 hr'] },
                        {
                            id: 'purchase-methods',
                            name: 'Purchase methods',
                            content: ['SOP 1', 'SOP 2'],
            ...
            expect(await getServerSideProps(ctx)).toStrictEqual({
                props: {
                    ...
                    productDetailsElements: [
                        ...
                        { id: 'quantity-in-bundle', name: 'Quantity in bundle', content: ['10'] },
                        { id: 'carnet-expiry', name: 'Carnet expiry', content: ['No expiry'] },
                        {
                            id: 'return-ticket-validity',
                            name: 'Return ticket validity',
                            content: ['3 month(s)'],
