// Environments for flags to be enabled in
//   Comment out unused to avoid linting issues
// const dev = ['dev'].includes(process.env.STAGE ?? '');
// const test = ['test'].includes(process.env.STAGE ?? '');
