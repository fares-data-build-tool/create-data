...
const OtherProducts = ({ otherProducts, exportEnabled, csrfToken }: OtherProductsProps): ReactElement => {
...
export const getServerSideProps = async (ctx: NextPageContextWithSession): Promise<{ props: OtherProductsProps }> => {
    ...
    return { props: { otherProducts, exportEnabled, csrfToken: getCsrfToken(ctx) } };
};
