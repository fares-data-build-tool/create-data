...
describe('csvZoneUpload', () => {
    ...
    it.each([
        [csvData.testCsv, csvData.unprocessedObject.Body],
        [csvData.testCsvWithEmptyCells, csvData.unprocessedObjectWithEmptyCells.Body],
        ...
        expect(s3.putStringInS3).toBeCalledTimes(1);
    });
});
