module.exports = /******/ (function(modules) {
    ...
    /******/
    /******/
    /******/ /******/ return __webpack_require__((__webpack_require__.s = 'Qquk'));
    /******/
})(
    /************************************************************************/
    /******/ {
        ...
        /***/ Qquk: /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            ...
            function handleRewrites(parsedUrl) {
                for (const rewrite of private_dot_next_routes_manifest_json__WEBPACK_IMPORTED_MODULE_4__[
                    ...
                    if (params) {
                        ...
                        if (parsedUrl.pathname === '/api/direction') {
                            break;
                        }
                    }
                }
            ...
            /* harmony default export */ __webpack_exports__['default'] = async (req, res) => {
                try {
                    ...
                    const resolver = __webpack_require__('bftn');
        ...
        /***/ bftn: /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            /* harmony import */ var cookies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__('Q/R2');
            /* harmony import */ var cookies__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
            ...
            /* harmony import */ var _constants_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__('jxKE');
            /* harmony import */ var _service_validator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__('MqiB');
            /* harmony import */ var _apiUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__('AivP');

            /* harmony default export */ __webpack_exports__['default'] = (req, res) => {
                try {
                    if (!Object(_service_validator__WEBPACK_IMPORTED_MODULE_2__['isSessionValid'])(req, res)) {
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_3__['redirectToError'])(res);
                        return;
                    }
                    ...
                    if (!journeyPattern) {
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_3__['redirectTo'])(res, '/direction');
                        return;
                    }
                    ...
                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_3__['setCookieOnResponseObject'])(
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_3__['getDomain'])(req),
                        _constants_index__WEBPACK_IMPORTED_MODULE_1__[/* JOURNEY_COOKIE */ 'g'],
                        cookieValue,
                        req,
                        res,
                    );
                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_3__['redirectTo'])(res, '/inputMethod');
                } catch (error) {
                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_3__['redirectToError'])(res);
                }
            };
