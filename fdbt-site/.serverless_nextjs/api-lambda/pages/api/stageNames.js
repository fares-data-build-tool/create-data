module.exports = /******/ (function(modules) {
    ...
    /******/
    /******/
    /******/ /******/ return __webpack_require__((__webpack_require__.s = 'sIKK'));
    /******/
})(
    /************************************************************************/
    /******/ {
        ...
        /***/ AivP: /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'getDomain', function() {
                return getDomain;
            });
            /* harmony export (binding) */ __webpack_require__.d(
                ...
                function() {
                    return setCookieOnResponseObject;
                },
            );
            /* harmony export (binding) */ __webpack_require__.d(
                __webpack_exports__,
                ...
                function() {
                    return deleteCookieOnResponseObject;
                },
            );
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'getUuidFromCookie', function() {
                return getUuidFromCookie;
            });
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'redirectTo', function() {
                return redirectTo;
            });
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'redirectToError', function() {
            ...
            /* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__('jxKE');
            ...
            const getDomain = req => {
                ...
                const host =
                    req === null || req === void 0
                        ...
                        ? void 0
                        : _req$headers.origin;
                return host ? host.replace(/(^\w+:|^)\/\//, '').split(':')[0] : '';
            };
            const setCookieOnResponseObject = (domain, cookieName, cookieValue, req, res) => {
                const cookieOptions = _objectSpread(
                    {},
                    true
                        ? {
                              secure: true,
                ...
                const cookies = new cookies__WEBPACK_IMPORTED_MODULE_0___default.a(req, res, cookieOptions); // From docs: All cookies are httponly by default, and cookies sent over SSL are secure by
            ...
            const deleteCookieOnResponseObject = (domain, cookieName, req, res) => {
                const cookies = new cookies__WEBPACK_IMPORTED_MODULE_0___default.a(req, res);
            ...
            const getUuidFromCookie = (req, res) => {
                const cookies = new cookies__WEBPACK_IMPORTED_MODULE_0___default.a(req, res);
                const operatorCookie = unescape(
                    decodeURI(cookies.get(_constants__WEBPACK_IMPORTED_MODULE_1__[/* OPERATOR_COOKIE */ 'h']) || ''),
                );
        ...
        /***/ G7GG: /***/ function(module, exports, __webpack_require__) {
            'use strict';
            /*!
             * bytes
        ...
        /***/ Gpjc: /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'isStageNameValid', function() {
                return isStageNameValid;
            });
            /* harmony import */ var _constants_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__('jxKE');
            /* harmony import */ var _service_validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__('MqiB');
            /* harmony import */ var _apiUtils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__('AivP');

            const isStageNameValid = req => {
            ...
            /* harmony default export */ __webpack_exports__['default'] = (req, res) => {
                try {
                    if (!Object(_service_validator__WEBPACK_IMPORTED_MODULE_1__['isSessionValid'])(req, res)) {
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_2__['redirectToError'])(res);
                        return;
                    }
                    ...
                    if (!userInputValidity.some(el => el.Error !== '')) {
                        ...
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_2__['setCookieOnResponseObject'])(
                            Object(_apiUtils__WEBPACK_IMPORTED_MODULE_2__['getDomain'])(req),
                            _constants_index__WEBPACK_IMPORTED_MODULE_0__[/* STAGE_NAMES_COOKIE */ 'j'],
                            stageNameCookieValue,
                            req,
                            res,
                        ); // deleteCookieOnResponseObject(getDomain(req), STAGE_NAME_VALIDATION_COOKIE, req, res);

                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_2__['redirectTo'])(res, '/priceEntry');
                    } else {
                        const validationCookieValue = JSON.stringify(userInputValidity);
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_2__['setCookieOnResponseObject'])(
                            Object(_apiUtils__WEBPACK_IMPORTED_MODULE_2__['getDomain'])(req),
                            _constants_index__WEBPACK_IMPORTED_MODULE_0__[/* STAGE_NAME_VALIDATION_COOKIE */ 'k'],
                            validationCookieValue,
                            req,
                            res,
                        );
                        Object(_apiUtils__WEBPACK_IMPORTED_MODULE_2__['redirectTo'])(res, '/stageNames');
                    }
                } catch (error) {
                    Object(_apiUtils__WEBPACK_IMPORTED_MODULE_2__['redirectToError'])(res);
                }
        ...
        /***/ MqiB: /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'isSessionValid', function() {
                return isSessionValid;
            });
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'isCookiesUUIDMatch', function() {
                return isCookiesUUIDMatch;
            });
            /* harmony import */ var cookies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__('Q/R2');
            /* harmony import */ var cookies__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
                cookies__WEBPACK_IMPORTED_MODULE_0__,
            );
            /* harmony import */ var _constants_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__('jxKE');

            const isSessionValid = (req, res) => {
                const cookies = new cookies__WEBPACK_IMPORTED_MODULE_0___default.a(req, res);
                const operatorCookie =
                    cookies.get(_constants_index__WEBPACK_IMPORTED_MODULE_1__[/* OPERATOR_COOKIE */ 'h']) || '';
            ...
            const isCookiesUUIDMatch = (req, res) => {
                const cookies = new cookies__WEBPACK_IMPORTED_MODULE_0___default.a(req, res);
                const operatorCookie = unescape(
                    decodeURI(
                        cookies.get(_constants_index__WEBPACK_IMPORTED_MODULE_1__[/* OPERATOR_COOKIE */ 'h']) || '',
                ...
                const serviceCookie = unescape(
                    decodeURI(
                        cookies.get(_constants_index__WEBPACK_IMPORTED_MODULE_1__[/* SERVICE_COOKIE */ 'i']) || '',
                    ),
                );
                const fareTypeCookie = unescape(
                    decodeURI(
                        cookies.get(_constants_index__WEBPACK_IMPORTED_MODULE_1__[/* FARETYPE_COOKIE */ 'c']) || '',
                    ),
                );
                const journeyCookie = unescape(
                    decodeURI(
                        cookies.get(_constants_index__WEBPACK_IMPORTED_MODULE_1__[/* JOURNEY_COOKIE */ 'g']) || '',
                    ),
                );
        ...
        /***/ sIKK: /***/ function(module, __webpack_exports__, __webpack_require__) {
            'use strict';
            __webpack_require__.r(__webpack_exports__);
            ...
            /* harmony import */ var private_dot_next_routes_manifest_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
                'Skye',
            );
            var private_dot_next_routes_manifest_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/ __webpack_require__.t(
                'Skye',
                1,
            );
            /* harmony import */ var next_dist_next_server_server_lib_path_match__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
                'uDRR',
            );
            /* harmony import */ var next_dist_next_server_server_lib_path_match__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/ __webpack_require__.n(
                next_dist_next_server_server_lib_path_match__WEBPACK_IMPORTED_MODULE_5__,
            );

            const getCustomRouteMatcher = next_dist_next_server_server_lib_path_match__WEBPACK_IMPORTED_MODULE_5___default()(
                true,
            );

            function handleRewrites(parsedUrl) {
                for (const rewrite of private_dot_next_routes_manifest_json__WEBPACK_IMPORTED_MODULE_4__[
                    /* rewrites */ 'a'
                ]) {
                    ...
                    if (params) {
                        ...
                        const destCompiler = next_dist_next_server_server_lib_path_match__WEBPACK_IMPORTED_MODULE_5__[
                            'pathToRegexp'
                        ].compile(`${parsedDest.pathname}${parsedDest.hash || ''}`);
                        ...
                        if (parsedUrl.pathname === '/api/stageNames') {
                            break;
                        }
                    }
                }
            ...
            /* harmony default export */ __webpack_exports__['default'] = async (req, res) => {
                try {
                    await Object(
                        next_plugin_loader_middleware_on_init_server___WEBPACK_IMPORTED_MODULE_2__['default'],
                    )();
                    ...
                    const resolver = __webpack_require__('Gpjc');
        ...
        /***/ vv4h: /***/ function(module, exports, __webpack_require__) {
            ...
            function getPagePath(page, distDir, serverless, dev) {
                const serverBuildPath = path_1.join(
                    distDir,
                    serverless && !dev ? constants_1.SERVERLESS_DIRECTORY : constants_1.SERVER_DIRECTORY,
                );
